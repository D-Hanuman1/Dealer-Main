...
@Component({
  selector: 'app-publishersearch',
  templateUrl: './publishersearch.component.html',
  styleUrls: ['./publishersearch.component.scss']
})
export class publishersearchComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,private sharedService:SharedserviceService,private dialogRef: MatDialogRef<publishersearchComponent>) { }
